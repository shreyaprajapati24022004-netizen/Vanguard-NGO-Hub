        ...
        <div className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-8">
          ...
          {activeTab === "overview" && (
            <div className="space-y-8 animate-fade-in">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <StatCard loading={loading} icon="👥" label="Total Users"     value={users.length}           color="bg-navy-50 dark:bg-navy-800/60" />
                <StatCard loading={loading} icon="🙋" label="Volunteers"      value={roleCount("volunteer")} color="bg-teal-50 dark:bg-teal-500/15" />
                <StatCard loading={loading} icon="🏢" label="NGOs"            value={roleCount("ngo")}       color="bg-indigo-50 dark:bg-indigo-500/15" />
                <StatCard loading={loading} icon="📋" label="Community Needs" value={needs.length}           color="bg-amber-50 dark:bg-amber-500/15" />
              </div>
          ...
          {activeTab === "volunteers" && (
            <div className="animate-fade-in">
              ...
              ) : volunteers.length === 0 ? <NoVolunteersEmpty /> : (
