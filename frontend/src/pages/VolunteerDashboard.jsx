...
const VolunteerDashboard = () => {
  ...
  const fetchMatches = async () => {
    setLoading(true);
    try { const { data } = await API.get("/api/matches/volunteer"); setMatches(data); }
        ...
        <div className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-3 sm:ml-auto">
                <div className="text-right">
                  ...
                  <p className={`text-sm font-bold ${available ? "text-emerald-600 dark:text-emerald-400" : "text-red-500 dark:text-red-400"}`}>
          ...
          <div className="animate-fade-in">
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-display font-bold text-gray-900 dark:text-white text-sm">
                {displayMatches.length} {activeTab} match{displayMatches.length !== 1 ? "es" : ""}
              </h2>
